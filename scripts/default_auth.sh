...
# sozo -P $PROFILE auth grant --world $WORLD_ADDRESS --fee-estimate-multiplier 10 --wait writer\
...
# echo "Initializing..."
# sozo -P $PROFILE execute  --world $WORLD_ADDRESS $RYO_ADDRESS initialize --calldata $PAPER_MOCK_ADDRESS,$TREASURY_ADDRESS,$LAUNDROMAT_ADDRESS --fee-estimate-multiplier 10  --wait
# echo "Initialized RYO!"
# sleep $TX_SLEEP

sozo -P $PROFILE execute --world $WORLD_ADDRESS $CONFIG_ADDRESS initialize_1 --fee-estimate-multiplier 2 --wait 
echo "Initialized CONFIG 1!"
sleep $TX_SLEEP

sozo -P $PROFILE execute --world $WORLD_ADDRESS $CONFIG_ADDRESS initialize_2 --fee-estimate-multiplier 2 --wait 
...
sozo -P $PROFILE auth grant --world $WORLD_ADDRESS --fee-estimate-multiplier 2  --wait writer\
...
sozo -P $PROFILE execute --world $WORLD_ADDRESS $PAPER_MOCK_ADDRESS initializer --fee-estimate-multiplier 2 --wait 
echo "Initialized PAPER_MOCK!"
sleep $TX_SLEEP


sozo -P $PROFILE execute --world $WORLD_ADDRESS $PAPER_MOCK_ADDRESS faucetTo -c $LAUNDROMAT_ADDRESS --fee-estimate-multiplier 2 --wait 
